...
/*   Updated: 2018/01/23 09:17:40 by jpinyot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libprintf.h"

static void	ft_unsigned_int_check_length(uintmax_t num, t_arg *arg)
{
...
int			conv_unsigned_int(va_list ap, t_arg *arg, int conv)
{
	...
	ft_unsigned_int_check_length(num, arg);
	if (arg->prefix > 0)
	{
		if (conv == 'X')
			arg->prefix = 88;
